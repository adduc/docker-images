#!/bin/sh
##
# This script is used to automatically tune the number of worker
# processes in the nginx configuration file based on the number of
# vCPUs available to the container.
##

## Taken from https://github.com/nginx/docker-nginx/blob/7f1d49f6f222f7e588a9066fd53a0ce43c3466a5/stable/alpine-slim/30-tune-worker-processes.sh
